...
# RAG sobre la LPI. Casos prácticos. (NotebookLM)
---

## Caso 1: (Derechos de creación artísticas)
Caso 1: Derechos de Creación Artística (Derecho de Autor)
El Rechazo de Protección a Obras Generadas de Manera Autónoma por IA
Este caso se centra en la doctrina legal que exige que el autor de una obra protegida sea una persona física.
A. Descripción y Hechos del Caso
El conflicto surge cuando se intenta registrar una obra artística (como una pintura, música o un cómic) cuyas características creativas han sido generadas íntegramente por un sistema de Inteligencia Artificial (IA) sin una intervención humana creativa y sustancial.
Un ejemplo destacado de esta problemática es el intento de registrar obras generadas por sistemas como MidJourney o DALL·E. En un caso específico, una autora creó un cómic cuyo texto y guion (obra literaria) fueron escritos por ella, pero todas las ilustraciones (obra artística) fueron generadas mediante IA.
B. Repercusión y Decisión Legal (Jurisdicción de EE. UU. y Principio Global)
El precedente legal clave, referido en los círculos internacionales, es el caso de "Thaler contra la Oficina del Derecho de Autor" (Thaler v. Copyright Office) en Estados Unidos:
1. Fundamento Legal: Los tribunales estadounidenses determinaron que una obra generada por IA no podía recibir protección de derechos de autor debido a la falta de autoría humana. La Oficina del Derecho de Autor ha manifestado que solo registrará una obra original de autoría siempre que haya sido creada por el ser humano. En Europa, la originalidad de una obra debe reflejar la "creación intelectual del autor," lo que implica claramente un autor humano.
2. Autoría Humana: El derecho de autor está reservado a las creaciones de personas físicas o "personas naturales". Una máquina, al carecer de personalidad jurídica, no puede ser legalmente reconocida como autora.
3. Resultado de la Obra: Cuando una obra (como las ilustraciones del cómic) es generada automáticamente por IA, el registro de la propiedad intelectual es cancelado o denegado para esa parte, ya que la obra no puede ser protegida por carecer de autoría humana.
4. Consecuencia: Las obras generadas puramente por IA, sin esa aportación humana creativa sustancial, caen inmediatamente en el Dominio Público.
Repercusión en la Creación Artística: Este caso establece que el sistema de Derecho de Autor protege la expresión original de una idea por parte de una persona, pero no protege el resultado si la creación no es el fruto del trabajo intelectual humano. La autora del cómic sería considerada autora plena de la parte literaria (el guion), pero no de la parte de ilustración generada por la máquina.
